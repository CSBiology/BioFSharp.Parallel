...
module ProjectInfo = 
    ...
    let project = "BioFSharp.Parallel"

    let summary = "GPU parallelized functions from BioFSharp"
    ...
    let gitName = "BioFSharp.Parallel"

    let solutionFile = "BioFSharp.Parallel.sln"

    let gitHome = sprintf "%s/%s" "https://github.com" gitOwner

    let projectRepo = sprintf "%s/%s/%s" "https://github.com" gitOwner gitName

    let website = "/BioFSharp.Parallel"

    let testProject = "tests/BioFSharp.Parallel.Tests/BioFSharp.Parallel.Tests.fsproj"
